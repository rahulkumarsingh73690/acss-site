...
<p><a href="https://github.com/acss-io/atomizer">Atomizer</a> is a tool for creating Atomic CSS rulesets. Generate an Atomic stylesheet dynamically from the Atomic classes you&#39;re actually using in your project (no unused styles!), or predeclare styles in configuration - it&#39;s up to you. Atomizer is not opinionated, brings no CSS of its own, and integrates nicely with your favorite task runner.</p>
</div>
