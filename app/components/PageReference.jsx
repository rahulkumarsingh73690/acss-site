    ...
    render() {
        return (
            <div id="reference" role="main" className="reference-page innerwrapper Mb(50px) Mx(10px) Maw(1000px)--sm Mx(a)--sm W(90%)--sm">
                ...
                <p>You can also <a href="/guides/syntax.html">learn about the syntax</a>, 
                   <a href="/guides/syntax.html#examples-">look at some examples</a>, 
                   <a href="/guides/atomic-classes.html">learn about custom classes</a>, 
                   or <a href="/guides/helper-classes.html">learn about helper/utility classes</a>.  
