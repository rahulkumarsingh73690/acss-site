    ...
    render: function () {
        ...
        return (
            <div className="Mb-50">
                ...
                <textarea id="customconfig" className="W-100% P-10" rows="10" placeholder="Configuration must be valid JSON" onChange={this.onConfigChange} value={customConfig}></textarea>
