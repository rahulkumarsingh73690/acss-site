    ...
    render: function () {
        return (
            <div>
                ...
                <input id="searchbox" type="search" role="search" className="D(ib) P(10px)" size="50" placeholder="Type classname or CSS declaration here..." autoFocus onChange={this.onQueryChange} value={this.state.currentQuery}></input>
            </div>
        );
    }
});
