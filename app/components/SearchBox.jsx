    ...
    render: function () {
        return (
            <div>
                ...
                <input id="searchbox" type="search" className="D-ib P-10" size="50" placeholder="Type classname or CSS declaration here..." onChange={this.onQueryChange} value={this.state.currentQuery}></input>
            </div>
        );
    }
});
